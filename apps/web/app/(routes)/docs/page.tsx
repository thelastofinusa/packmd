  ...
  const sections = [
      ...
      content: (
        <>
          <p className="text-sm leading-relaxed font-extralight text-muted-foreground sm:text-base">
            LLMs process Markdown far better than raw source code or HTML.
            Instead of forcing an AI to crawl file-by-file or parse messy
            DOMs—burning tokens on boilerplate and navigation—PackMD does the
    ...
    },
    {
      ...
      content: (
        <>
          <p className="text-sm leading-relaxed font-extralight text-muted-foreground sm:text-base">
            Under the hood, PackMD uses high‑performance filesystem traversal
            and modern web scraping APIs to construct the perfect context
            window.
          </p>
        ...
        <>
          ...
          <div className="mt-2 flex flex-col gap-6">
            <div className="flex flex-col gap-2">
              <span className="px-1.5 text-sm font-medium text-foreground sm:text-base">
                Installation
              </span>
              <Frame variant="inverse" className="rounded-xl">
            ...
            <div className="flex flex-col gap-2">
              ...
              <p className="px-1.5 text-xs leading-relaxed font-extralight text-muted-foreground sm:text-sm">
              ...
              },
              {
                ...
                content: () => (
                  <p className="text-sm text-muted-foreground">
                    ...
                    and expires automatically after {TOTAL_DAYS} days.
                  </p>
                ),
              },
              {
